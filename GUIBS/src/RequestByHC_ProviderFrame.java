...
public class RequestByHC_ProviderFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RequestByHC_ProviderFrame() {
		...
		table = new JTable(makeTableModel(SQLConnection.getRequestByHC_Provider()));
